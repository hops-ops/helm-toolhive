...
PACKAGE ?= helm-toolhive
XRD_DIR := apis/toolhives
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/toolhives/standard.yaml
...
EXAMPLES := \
    examples/toolhives/minimal.yaml:: \
    examples/toolhives/standard.yaml::
...
render\:%:
	@example="examples/toolhives/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
